...
const ContactPage = () => {
	...
	return (
		<>
			<HeadMeta metaTitle="Contact" metaDesc="Date de contact și informații utile despre redacție." />
			<HeaderOne />
			<Breadcrumb aPage="Contact" />
			<BreadcrumbBanner pageTitle="Contact" />
			<div className="axil-about-us section-gap  section-gap-top__with-text">
				<div className="container">
					<SectionTitleTwo title="Contactează redacția" paragraph="Ai întrebări, propuneri editoriale sau solicitări comerciale? Scrie-ne și îți răspundem în cel mai scurt timp.
                        <br />Suntem aici pentru detalii generale, colaborări și suport." />

              ...
              <div className="post-title-wrapper">
                <div className="post-metas banner-post-metas post-meta-primary load-anim">
                  <ul className="list-inline">
                    <li>
                      <span>De la </span>
                      <Link href={`/autor/${slugify(firstPost.author_name)}`} className="post-author">
                ...
                <h2 className="m-t-xs-20 m-b-xs-10 axil-post-title hover-line color-white txt-shadow  load-anim">
                  <Link href={getPostHref(firstPost)}>
                    {firstPost.title}
                  </Link>
                </h2>
                ...
                <div className="load-anim">
                  <Link href={getPostHref(firstPost)} className="btn btn-primary">
                    READ MORE
                  </Link>
                </div>
              </div>
